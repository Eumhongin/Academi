...
if($_POST['drop_value'] == 1)
{
  ...
  $result[0] = DB_echo("SELECT book_name FROM question_korean_book_name WHERE hide=1","book_name");
  $result[1] = DB_echo("SELECT book_num FROM question_korean_book_name WHERE hide=1","book_num");
...
}else if($_POST['drop_value'] == 2)
{
  ...
  $result[0] = DB_echo("SELECT book_name FROM question_book_name WHERE hide=1","book_name");
  $result[1] = DB_echo("SELECT book_num FROM question_book_name WHERE hide=1","book_num");
...
}else if($_POST['drop_value'] == 3)
{
  ...
  $result[0] = DB_echo("SELECT book_name FROM question_eng_book_name WHERE hide=1","book_name");
  $result[1] = DB_echo("SELECT book_num FROM question_eng_book_name WHERE hide=1","book_num");
...
}else if($_POST['drop_value'] == 4)
{
  ...
  $result[0] = DB_echo("SELECT book_name FROM question_social_book_name WHERE hide=1","book_name");
  $result[1] = DB_echo("SELECT book_num FROM question_social_book_name WHERE hide=1","book_num");
...
}else if($_POST['drop_value'] == 5)
{
  ...
  $result[0] = DB_echo("SELECT book_name FROM question_science_book_name WHERE hide=1","book_name");
  $result[1] = DB_echo("SELECT book_num FROM question_science_book_name WHERE hide=1","book_num");
